        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div style={slide("left")}>
            ...
            <div className="space-y-4 text-gray-400 leading-relaxed text-base">
              <p>
                I'm Peter Kalu, a passionate software developer with extensive
                experience creating comprehensive digital solutions across
                various industries. My journey has taken me through diverse
                projects from healthcare to education, building systems that
                make a real impact.
              </p>
              <p>
                I specialize in modern web technologies including React,
                Node.js, and PostgreSQL, always staying current with industry
                best practices. My expertise spans both frontend and backend
                development, with a strong focus on creating scalable,
                user-friendly applications.
              </p>
              <p>
                From school management systems to e-commerce platforms, I've
                delivered solutions that streamline operations and enhance user
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="glass rounded-2xl p-5 border border-white/5 hover:border-indigo-500/30 transition-all duration-300 hover:-translate-y-1 cursor-default"
                >
                  <i
                    className={`${s.icon} text-indigo-400 text-xl mb-2 block`}
                  />
