...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-950">
      ...
      <div className="absolute top-1/2 -right-48 w-[400px] h-[400px] rounded-full bg-violet-600/20 blur-3xl animate-orb pointer-events-none" style={{ animationDelay: '2.5s' }} />
      <div className="absolute -bottom-32 left-1/3 w-[350px] h-[350px] rounded-full bg-cyan-600/15 blur-3xl animate-orb pointer-events-none" style={{ animationDelay: '5s' }} />
      ...
      {[
        ...
        <div
          ...
          style={{ top: tag.top, left: tag.left, right: tag.right, bottom: tag.bottom, animationDelay: tag.delay }}
        >
      ...
      <div className="max-w-7xl mx-auto px-6 text-center text-white w-full relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Badge */}
          <div style={trans(0)} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 text-sm mb-8 cursor-default">
            <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse inline-block" />
            Available for new projects
          </div>

          {/* Name */}
          <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight" style={trans(0.1)}>
            Hello, I'm{' '}
            <span className="gradient-text">Peter Kalu</span>
          </h1>

          {/* Typewriter */}
          <div className="h-12 flex items-center justify-center gap-1 mb-6" style={trans(0.2)}>
          ...
          <p className="text-base md:text-lg mb-10 text-gray-400 leading-relaxed max-w-2xl mx-auto" style={trans(0.3)}>
            Crafting comprehensive digital solutions across healthcare, education,
            and business management — from pixel-perfect UIs to robust backend systems.
          </p>

          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16" style={trans(0.4)}>
            <a
              href="#projects"
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto" style={trans(0.5)}>
            {[
              { value: '20+', label: 'Projects' },
              { value: '6+', label: 'Years Exp.' },
              { value: '5+', label: 'Industries' },
            ].map((s, i) => (
              <div key={i} className="glass rounded-2xl px-4 py-5 hover:border-indigo-500/30 transition-colors duration-300 cursor-default">
